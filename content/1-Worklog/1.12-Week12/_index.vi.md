...
| --- | --- | --- | --- | --- |
| Thứ 2 | - Hoàn thiện tài liệu Bản đề xuất dự án (Proposal):<br> - **Thực hành:** <br>&emsp; + Viết lại toàn bộ Bản đề xuất (Proposal).<br>&emsp; + Tích hợp sơ đồ kiến trúc khối tĩnh bằng Mermaid (3 lớp bảo mật).<br>&emsp; + Xây dựng bảng tính toán chi phí vận hành chi tiết bằng AWS Pricing Calculator. | 06/07/2026 | 06/07/2026 | [Bản đề xuất](https://xduc695.github.io/fcj-workshop-template/vi/2-proposal/) |
| Thứ 3 | - Biên soạn báo cáo Tự đánh giá (Self-Evaluation):<br> - **Thực hành:** <br>&emsp; + Tổng hợp các kỹ năng chuyên môn (Hard skills) và kỹ năng mềm (Soft skills).<br>&emsp; + Đánh giá khách quan mức độ hoàn thành (Khá, Tốt, Trung bình).<br>&emsp; + Phân tích sâu các điểm cần cải thiện (Quản lý thời gian, tối ưu code). | 07/07/2026 | 07/07/2026 | [Tự đánh giá](https://xduc695.github.io/fcj-workshop-template/vi/6-self-evaluation/) |
| Thứ 4 | - Biên soạn báo cáo Chia sẻ, đóng góp ý kiến (Feedback):<br> - **Thực hành:** <br>&emsp; + Viết đánh giá về lộ trình 12 tuần thực tập kiến trúc AWS Microservices.<br>&emsp; + Đề xuất cải thiện tài liệu và quy trình hỗ trợ sinh viên.<br>&emsp; + Biên dịch song ngữ Anh - Việt cho phần chia sẻ. | 08/07/2026 | 08/07/2026 | [Feedback](https://xduc695.github.io/fcj-workshop-template/vi/7-feedback/) |
